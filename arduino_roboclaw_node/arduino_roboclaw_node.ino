...
//      leftMotor->run(BACKWARD);
        roboclaw.BackwardM1(address,abs(PWM_leftMotor));
    }
    else {                                               //Going backward
//      leftMotor->setSpeed(abs(PWM_leftMotor));
//      leftMotor->run(FORWARD);
        roboclaw.ForwardM1(address,abs(PWM_leftMotor));
    }
...
//      rightMotor->run(FORWARD);
        roboclaw.ForwardM2(address,abs(PWM_rightMotor));
    }
    else {                                                //Going backward
//      rightMotor->setSpeed(abs(PWM_rightMotor));
//      rightMotor->run(BACKWARD);
        roboclaw.BackwardM2(address,abs(PWM_rightMotor));
    }
